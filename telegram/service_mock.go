...
func (m *MockService) requestAuthorisation(arg0 uint32, arg1 string) (string, error) {
	ret := m.ctrl.Call(m, "requestAuthorisation", arg0, arg1)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) requestAuthorisation(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "requestAuthorisation", reflect.TypeOf((*MockService)(nil).requestAuthorisation), arg0, arg1)
}
